 ...
 *  ContactCategory - .
 */
public class ContactCategory extends VirtualRecord
     implements ContactCategoryModel
{
     ...
     * Constructor.
     */
    public ContactCategory(RecordOwner screen)
    {
        this();
        this.init(screen);
    }
    ...
    {
        return (m_tableName == null) ? Record.formatTableNames(CONTACT_CATEGORY_FILE, bAddQuotes) : super.getTableNames(bAddQuotes);
    }
    /**
