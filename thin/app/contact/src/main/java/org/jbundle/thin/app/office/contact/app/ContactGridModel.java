 ...
 */
public class ContactGridModel extends ThinTableModel
{
    ...
    public static final int CONTACT = NAME + 1;
    public static final int CITY_OR_TOWN = CONTACT + 1;
    public static final int TEL = CITY_OR_TOWN + 1;
    public static final int EMAIL = TEL + 1;
    public static final int COLUMN_COUNT = EMAIL + 1;
    
    /**
     *  OrderEntry Class Constructor.
     */
    public ContactGridModel()
    {
        super();
    }
    /**
     *  OrderEntry Class Constructor.
     */
    public ContactGridModel(FieldTable table)
    {
        this();
        this.init(table);
    }
    ...
    public Convert getFieldInfo(int iIndex)
    {
        ...
        switch (iIndex)
        {
            ...
            case DELETE_BUTTON_COLUMN:
                return null;
            case NAME:
                return fieldList.getField(Contact.NAME);
            case CONTACT:
                return fieldList.getField(Contact.CONTACT);
            case CITY_OR_TOWN:
                return fieldList.getField(Contact.CITY_OR_TOWN);
            case TEL:
                return fieldList.getField(Contact.TEL);
            case EMAIL:
                return fieldList.getField(Contact.EMAIL);
        }
